...
class Test_6_MaxLevelHeuristic(BaseHeuristicTest):
    def test_6a_maxlevel(self):
        ...
        #print()
        #print()
        #print("cake node: ", self.cake_node)
        #print("cake node type: ", type(self.cake_node))
        #print("cake problem: ", self.cake_problem)
        #print("cake problem type: ", type(self.cake_problem))
        #print("Value: ", self.cake_problem.h_pg_maxlevel(self.cake_node))
